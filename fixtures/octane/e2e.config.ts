...
import * as Octane from "@distilled.cloud/octane";
...
export default Options.make({
  ...
  // runs don't collide. `framework: "@distilled.cloud/octane"` (the string
  // form) works identically when no framework-specific options are needed.
  // The deploy target defaults to `@distilled.cloud/octane/cloudflare`.
  framework: (options) => {
