...
function initRuntime() {
  ...
  Object.assign(globalThis, {
    ...
    __BUILD_TIMESTAMP_MS__: 1784570196210,
    __NEXT_BASE_PATH__: "",
...
var init_logger = __esm({
  "../../node_modules/.bun/@opennextjs+aws@4.0.2+609e97a7004bde1e/node_modules/@opennextjs/aws/dist/adapters/logger.js"() {
    ...
    isDownplayedErrorLog2 = (errorLog) => DOWNPLAYED_ERROR_LOGS2.some((downplayedInput) => downplayedInput.clientName === errorLog?.clientName && downplayedInput.commandName === errorLog?.commandName && (downplayedInput.errorName === errorLog?.error?.name || downplayedInput.errorName === errorLog?.error?.Code));
  }
});
...
var require_px_next_dist_esm_build_templates_edge_wrapper_12ai1tm = __commonJS({
  ".next/server/edge/chunks/1_px_next_dist_esm_build_templates_edge-wrapper_12ai1tm.js"() {
    ...
    (globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/1_px_next_dist_esm_build_templates_edge-wrapper_12ai1tm.js", { otherChunks: ["chunks/1pge_next_dist_esm_build_templates_edge-wrapper_1_4jr7d.js", "chunks/[root-of-the-server]__0fwp9mf._.js"], runtimeModuleIds: [30170] }]), (() => {
      ...
      }, l.t = "function" == typeof __require2 ? __require2 : function() {
      ...
      }, B.resolve = (e2, t2) => __require2.resolve(e2, t2), l.x = B, e = { registerChunk(e2, t2) {
        let r2 = (function(e3) {
...
async function createGenericHandler(handler3) {
  const config = await import("./chunks/open-next.config-HWZV7FEL.js").then((m) => m.default);
...
var isDownplayedErrorLog3 = (errorLog) => DOWNPLAYED_ERROR_LOGS3.some((downplayedInput) => downplayedInput.clientName === errorLog?.clientName && downplayedInput.commandName === errorLog?.commandName && (downplayedInput.errorName === errorLog?.error?.name || downplayedInput.errorName === errorLog?.error?.Code));
...
var DOQueueHandler = class extends DurableObject {
    ...
    try {
      ...
      response = await this.service.fetch(`${protocol}://${host}${url}`, {
        ...
        headers: {
          ...
          "x-prerender-revalidate": "4a23980e7c1d5ee05c33022acf4293c1",
          "x-isr": "1"
        },
  ...
  async addToFailedState(msg) {
    ...
    if (!this.disableSQLite) {
      this.sql.exec("INSERT OR REPLACE INTO failed_state (id, data, buildId) VALUES (?, ?, ?)", msg.MessageDeduplicationId, JSON.stringify(updatedFailedState), "S-0_a9VRZfnloGAua04pT");
    }
    await this.addAlarm();
  }
  async addAlarm() {
  ...
  async initState() {
    ...
    this.sql.exec("DELETE FROM failed_state WHERE buildId != ?", "S-0_a9VRZfnloGAua04pT");
    this.sql.exec("DELETE FROM sync WHERE buildId != ?", "S-0_a9VRZfnloGAua04pT");
...
var isDownplayedErrorLog4 = (errorLog) => DOWNPLAYED_ERROR_LOGS4.some((downplayedInput) => downplayedInput.clientName === errorLog?.clientName && downplayedInput.commandName === errorLog?.commandName && (downplayedInput.errorName === errorLog?.error?.name || downplayedInput.errorName === errorLog?.error?.Code));
...
var worker_default = {
  async fetch(request, env, ctx) {
    return runWithCloudflareRequestContext(request, env, ctx, async () => {
      ...
      const reqOrResp = await handler2(request, env, ctx);
      if (reqOrResp instanceof Response) {
        return reqOrResp;
      }
      const { handler: handler3 } = await import("./chunks/handler-O7QHNSHR.js");
      return handler3(reqOrResp, env, ctx, request.signal);
    });
  }
};
export {
