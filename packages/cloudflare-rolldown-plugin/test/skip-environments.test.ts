...
import { parseViteEnvironments, type BasePluginOptions } from "../src/options.js";
import {
  ...
  it("tolerates environments whose optimizer does not support registerMissingImport", async () => {
    ...
    const server = {
      environments: {
        ...
        prerender: makeEnvironment("prerender", { noDiscovery: true, throws: true }),
        ...
        bare: { name: "bare", config: { optimizeDeps: {} }, depsOptimizer: undefined },
      },
    };
