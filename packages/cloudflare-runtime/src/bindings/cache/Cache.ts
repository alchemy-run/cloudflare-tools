...
import * as CacheWorker from "worker:./Cache.worker.ts";
          ...
          defer: Effect.gen(function* () {
                ...
                bindings: [
                  {
                    ...
                    durableObjectNamespace: { className: CACHE_OBJECT_CLASS_NAME },
                  },
                  {
                  ...
                  ...(enableControlEndpoints
                    ? [{ name: BINDING_CACHE_ENABLE_CONTROL_ENDPOINTS, json: "true" }]
                    : []),
                ],
              },
            };
            return {
              ...
              userWorker: {
                cacheApiOutbound: {
                  name: SERVICE_CACHE,
                  props: { json: JSON.stringify({ enabled } satisfies CacheServiceProps) },
                },
              },
            };
          }),
