...
import * as SecretsStoreStoreWorker from "worker:./SecretsStore.worker.ts";
import * as SecretsStoreSecretWorker from "worker:./SecretsStoreSecret.worker.ts";
          ...
          defer: Effect.gen(function* () {
            ...
            const storeService: WorkerdConfig.Service = {
              ...
              worker: {
                ...
                durableObjectStorage: { localDisk: SERVICE_SECRETS_STORE_STORAGE },
                bindings: [
                  {
                    name: BINDING_KV_OBJECT,
                    durableObjectNamespace: { className: SECRETS_STORE_OBJECT_CLASS_NAME },
                  },
                  {
                  ...
                  ...(enableControlEndpoints
                    ? [{ name: BINDING_KV_ENABLE_CONTROL_ENDPOINTS, json: "true" }]
                    : []),
                ],
              },
            };
