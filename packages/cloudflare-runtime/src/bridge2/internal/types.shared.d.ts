...
// `any` into inference.
export type Stubable = RpcTargetBranded | ((...args: Array<never>) => unknown);
...
type UnstubifyAll<A extends ReadonlyArray<unknown>> = { [I in keyof A]: Unstubify<A[I]> };
...
type MaybeCallableProvider<T> = T extends (...args: Array<any>) => any
  ? MethodOrProperty<T>
  : unknown;
