 ...
 * validation constants — lives behind `@distilled.cloud/octane/cloudflare`.
 */
...
/**
 * The e2e-harness factory contract (`framework: "@distilled.cloud/octane"`
 * in `e2e.config.ts`).
 */
const factory = (
